...
public class SignIn extends javax.swing.JFrame {
    ...
    public SignIn() {
        ...
        try{
            ...
            con  = DriverManager.getConnection ("jdbc:mysql://localhost:3306/uasp3","root","");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            String sql = "select * from sigin where username = '"+jTextField2.getText()+"' and password = '"+String.valueOf(jPasswordField1.getPassword())+"'";
            ResultSet rss = stt.executeQuery(sql);
            if(rss.next()){
                uasno2 = new UASno2();
                uasno2.setVisible(true);
                this.dispose();        }
            else {
